...
export async function createCourse(params:{name:string, instructors:Instructor[],periods:Period[], degrees:Degree[], exams:Exam[]}){
  const {name, periods, degrees, instructors, exams} = params;
